...
- **Set research allowances.** Assign each account one of five research tiers,
  including an unlimited research tier.
...
| --- | --- | --- |
| Native development | Git, uv, Python 3.13+, Node 22.22+ (Node 24 LTS recommended) and the pinned pnpm version | API, SQLite and Vite |
