...
export function WorldClocks() {
  ...
  return (
    ...
    >
      <dl className="pointer-events-auto grid max-w-full grid-cols-4 gap-x-2 gap-y-1.5 rounded-sm bg-black/75 px-2 py-1.5 text-center text-2xs text-muted backdrop-blur-sm sm:px-3 md:grid-cols-7 md:gap-x-3 xl:gap-x-6">
