...
const GROUPS: Record<string, readonly string[]> = {
  ...
  'Australia and New Zealand': ['australia', 'queensland', 'newzealand'],
...
const SEARCH_ALIASES: Record<string, string> = {
  ...
  newengland: 'New England Vermont New Hampshire Maine',
  idaho: 'Idaho',
  ...
  puertorico: 'Puerto Rico San Juan',
  lithuania: 'Lithuania Vilnius Baltic',
  ireland: 'Ireland Dublin TII',
  norway: 'Norway Oslo Statens vegvesen',
  hungary: 'Hungary Budapest',
  autostrade: 'Italy motorways Autostrade',
  luxembourg: 'Luxembourg CITA',
  ...
  northeast: 'England United Kingdom Newcastle Gateshead Sunderland Tyneside Tyne and Wear',
  northyorkshire: 'England United Kingdom North Yorkshire weather',
  westmorland: 'England United Kingdom Cumbria Lake District Westmorland Furness weather',
  derbyshire: 'England United Kingdom Derbyshire Peak District',
  'uk-local':
    'United Kingdom Isle of Man Argyll Bute Western Isles Hebrides Tamar Plymouth Mersey Gateway Runcorn Widnes Farnham Surrey',
