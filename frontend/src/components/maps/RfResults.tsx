...
export function RfResults({ result }: { result: ReturnType<typeof calculateRf> }) {
  ...
  return (
    ...
    >
      ...
      <p className="rf-help">
        The smaller of the smooth-Earth horizon and ideal distance at sensitivity plus reserve. The
        circle is a distance reference, not a coverage prediction or antenna beam.
      </p>
      ...
      <details className="rf-disclosure">
        ...
        <div className="rf-disclosure-body">
          ...
          <p className="mt-3 text-muted">
            ...
            interference, diffraction or antenna pattern is modelled. Very short distances may fall
            outside the far-field assumption. HF skywave and satellite links are not supported.
          </p>
