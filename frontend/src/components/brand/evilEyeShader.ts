// Original React Bits Evil Eye shader and noise. Licence/provenance: EvilEye.tsx and THIRD_PARTY_NOTICES.md.
...
export function generateNoiseTexture(size = 256): Uint8Array {
