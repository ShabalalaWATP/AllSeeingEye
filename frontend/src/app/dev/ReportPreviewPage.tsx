...
import { EvidenceNavigation } from '@/components/reports/EvidenceLinks';
...
import { EvidenceAnnex } from '@/features/reports/EvidenceAnnex';
import { ReportBodyView } from '@/features/reports/ReportSections';
import { ReportMasthead } from '@/features/reports/ReportMasthead';
import { publicationContents, ReportPublicationView } from '@/features/reports/ReportPublication';
...
const VIEWS = ['needs_review', 'ready', 'failed', 'structured', 'annex'] as const;
type View = (typeof VIEWS)[number];
const STATUSES: ReportStatus[] = ['needs_review', 'ready', 'failed'];
            ...
            {view === 'annex' ? (
              <div className="rounded-card border border-line bg-surface p-4">
                <EvidenceAnnex
                  ...
                  findings={report.version.findings}
                  status="ready"
                />
              </div>
            ) : (
