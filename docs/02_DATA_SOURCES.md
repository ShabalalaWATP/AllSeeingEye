...
| Telegram | `t.me/s/<channel>` | 200 (HTML) | Now collected for 64 curated channels; `t.me/robots.txt` and `telegram.org/robots.txt` both 404, so no crawl rules are published |
