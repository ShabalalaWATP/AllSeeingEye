...
Status, 8 September 2026: local acceptance passed, ready for integration from
`codex/annotation-inventory-monitoring`, based on integrated main `0c91741`.
...
- [ ] Merge into main and verify the accepted runtime tree is unchanged.
...
that pending test status; merge verification remains to be completed.
