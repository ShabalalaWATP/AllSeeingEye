...
| Left Map filters | Additional topics (cyber, social, political, humanitarian and economic), shared event time window and clear-time action. Connection, coverage and reload details expand on demand. |
...
| Right navigation and planning | Find nation, location precision, drawing, routing, RF calculations and measurement. |

The former Layers and settings panel repeated category and appearance controls.
Those copies have been removed. Category-specific filters further narrow the
