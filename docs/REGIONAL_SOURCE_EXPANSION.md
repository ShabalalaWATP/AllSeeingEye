...
| [Fintraffic / Digitraffic AIS](https://www.digitraffic.fi/en/marine-traffic/) | Bounded keyless regional live adapter implemented; one live response accepted | Finnish waterways, reported MMSI/movement and record-age expiry; [operations and attribution](VESSEL_TRAFFIC_OPERATIONS.md). Not worldwide coverage or verified identity |
