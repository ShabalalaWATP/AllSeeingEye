...
| [GLEIF Level 2](https://www.gleif.org/en/lei-data/access-and-use-lei-data/level-2-data-who-owns-whom) | D, public records | LEIs and reported accounting parents, not a complete beneficial-ownership register |
...
| [NASA FIRMS API](https://firms.modaps.eosdis.nasa.gov/api/) | Catalogue candidate, D onboarding | Thermal detections with free-key prerequisite; detections do not by themselves establish attacks or explosions |
