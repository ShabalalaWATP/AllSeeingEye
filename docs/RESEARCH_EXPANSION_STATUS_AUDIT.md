...
- 8 September: the pre-registry/monitor combined backend passed 3,195 tests,
  ...
  Report-wide inventory monitoring is implemented separately, with full backend
  acceptance passed (3,291 tests, 70 skips, 95.05% coverage) and 1,018 frontend
  passes. Integration verification follows; cross-version monitoring remains open.
