...
class UserRepository(Protocol):
    async def lock_by_id(self, user_id: UUID) -> User | None:
        """Serialise credential/session mutations until transaction completion; read fresh state."""
        ...

    async def lock_by_email(self, email: str) -> User | None: ...
    async def lock_administration(self) -> None:
        """Serialise administrator role/active transitions before locking individual users."""
        ...
