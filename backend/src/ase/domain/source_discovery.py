...
REGIONAL = {
    ...
    "economic_ons_releases": _jurisdiction("GB"),
    "economic_federal_reserve": _jurisdiction("US"),
    "economic_bls_consumer_prices": _jurisdiction("US"),
    "economic_bls_employment": _jurisdiction("US"),
    "economic_bls_producer_prices": _jurisdiction("US"),
    "economic_census_indicators": _jurisdiction("US"),
    "economic_eia_energy": _focus("US"),
    "economic_bank_japan": _jurisdiction("JP"),
    "economic_bank_canada": _jurisdiction("CA"),
    "economic_reserve_bank_india": _jurisdiction("IN"),
    "economic_bank_russia": _jurisdiction("RU"),
    "economic_the_bell": _focus("RU"),
