"""ACLED refresh storage, migration 0055, container wiring and requirement status."""
...
def _migration() -> ModuleType:
    path = next(VERSIONS.glob("0055_*.py"))
...
def test_migration_0055_matches_the_model_and_guards_retained_rotation() -> None:
    module = _migration()
